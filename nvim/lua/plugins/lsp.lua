...
-- =============================================================================
local mason_ui = require("config.ui").icons.mason
require("mason").setup({
  ui = {
    icons = {
      package_installed = mason_ui.package_installed,
      package_pending = mason_ui.package_pending,
      package_uninstalled = mason_ui.package_uninstalled,
    },
  },
})
